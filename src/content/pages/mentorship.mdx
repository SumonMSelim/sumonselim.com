...
import coverImage from "@/assets/pages/mentorship/cover.webp";

<Image src={coverImage} alt="Free Mentorship Session with Sumon Molla Selim" loading="eager" class="rounded-lg w-full" />
...
[Apply for the free mentorship session with Muhammad Sumon Molla Selim now!](https://adplist.org/mentors/muhammad-sumon-molla-selim?session=29973-swe-tech-and-career-growth-adda)
